        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Promotion_DiscountType", "[DiscountType]='FIXED_AMOUNT' OR [DiscountType]='PERCENTAGE'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Articles_ArticleCategories_CategoryId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PromotionConditions_Promotions_PromotionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Coupons_Promotions_PromotionId1",
                        column: x => x.PromotionId1,
                        principalTable: "Promotions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true, defaultValue: 0m),
                    CouponCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingFee = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true, defaultValue: 0m),
                    FinalAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PaymentMethod = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentStatus = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "Unpaid"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceModifier = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true, defaultValue: 0m),
                    ProductId1 = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductVariants_MasterColors_ColorId1",
                        column: x => x.ColorId1,
                        principalTable: "MasterColors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductVariants_MasterSizes_SizeId1",
                        column: x => x.SizeId1,
                        principalTable: "MasterSizes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    ProductVariantId = table.Column<int>(type: "int", nullable: false),
                    Snapshot_ProductName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Snapshot_Sku = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Snapshot_Thumbnail = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "ParentId", "ParentId1", "Slug" },
                values: new object[] { 1, "Men", null, null, "men" });

            migrationBuilder.InsertData(
                table: "MasterColors",
                columns: new[] { "Id", "HexCode", "Name" },
                values: new object[] { 1, "#000000", "Black" });
            ...
            migrationBuilder.InsertData(
                table: "Promotions",
                columns: new[] { "Id", "DiscountType", "DiscountValue", "EndDate", "Name", "Priority", "StartDate" },
                values: new object[] { 1, "PERCENTAGE", 10m, new DateTime(2025, 12, 31, 0, 0, 0, 0, DateTimeKind.Unspecified), "Summer Sale", 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarUrl", "DateOfBirth", "Email", "FullName", "GoogleId", "PasswordHash", "PhoneNumber", "Role", "Username" },
                values: new object[,]
                {
                    { 1, null, null, "admin@kantstore.com", "Admin", null, null, null, "Admin", null },
                    { 2, null, null, "customer@gmail.com", "Customer 1", null, null, null, "Customer", null }
                });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Name", "ParentId", "ParentId1", "Slug" },
                values: new object[] { 2, "T-Shirts", 1, null, "tshirts" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CategoryId1", "Description", "Name", "Price", "Slug", "Thumbnail" },
                values: new object[] { 1, 2, null, null, "Basic T-Shirt", 199000m, "basic-tshirt", null });

            migrationBuilder.InsertData(
                table: "ProductVariants",
                columns: new[] { "Id", "ColorId", "ColorId1", "PriceModifier", "ProductId", "ProductId1", "Quantity", "SizeId", "SizeId1", "Sku" },
                values: new object[] { 1, 1, null, 0m, 1, null, 50, 1, null, "TSHIRT-BLACK-M" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionConditions_PromotionId1",
                table: "PromotionConditions",
                column: "PromotionId1");
