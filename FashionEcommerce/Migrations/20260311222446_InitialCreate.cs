    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, true, "Uncategorized", null, "uncategorized" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarUrl", "CreatedAt", "DateOfBirth", "Email", "FullName", "GoogleId", "IsLocked", "PasswordHash", "PhoneNumber", "Role", "Username" },
                values: new object[] { 1, null, new DateTime(2026, 3, 11, 22, 24, 45, 665, DateTimeKind.Utc).AddTicks(8261), null, "admin@fashion.com", "Admin User", null, false, "$2a$11$CvaaIMQAdmA7ItvDuCzOzu.nt6Oa5z.aJDqHUF/rywF9p0u3lekQi", null, "Admin", null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreatedAt", "Description", "Discount", "IsActive", "Name", "Price", "Slug", "Stock", "Thumbnail" },
                values: new object[,]
                {
                    { 1, 1, new DateTime(2026, 3, 11, 22, 24, 45, 675, DateTimeKind.Utc).AddTicks(6719), "Cotton T-Shirt", 0m, true, "T-Shirt", 20m, "", 100, null },
                    { 2, 1, new DateTime(2026, 3, 11, 22, 24, 45, 675, DateTimeKind.Utc).AddTicks(7274), "Blue Jeans", 10m, true, "Jeans", 50m, "", 50, null }
                });
